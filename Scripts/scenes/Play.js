...
(function (scenes) {
    var Play = /** @class */ (function (_super) {
        ...
        Play.prototype.Start = function () {
            ...
            this._powerStone1 = new objects.Image(config.Game.ASSETS.getResult("stone"), "stone", 1000, 100, true);
            ...
            this._powerStone2 = new objects.Image(config.Game.ASSETS.getResult("stone"), "stone", 100, 700, true);
            ...
            this._powerStone3 = new objects.Image(config.Game.ASSETS.getResult("stone"), "stone", 1000, 700, true);
            ...
            this._powerStone4 = new objects.Image(config.Game.ASSETS.getResult("stone"), "stone", 600, 100, true);
            this.Main();
        };
